...
package uk.gov.hmrc.play.common
...
trait MongoSpecSupportFix {

  protected val databaseName: String = "test-" + this.getClass.getSimpleName
  protected val mongoUri: String = "mongodb://localhost:27017/test-play-schedule"
      //s"mongodb://127.0.0.1:27017/$databaseName?rm.monitorRefreshMS=4000&rm.failover=default"
  ...
  lazy val reactiveMongoComponent = new ReactiveMongoComponent {
